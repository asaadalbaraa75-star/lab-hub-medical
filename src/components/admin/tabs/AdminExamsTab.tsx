...
// Official Academic Reviewer (المراجع الأكاديمي المعتمد لجميع الأقسام)
export const OFFICIAL_MEDICAL_REVIEWERS = [
  { id: 'rev_thabet', name: 'الدكتور ثابت الذيفاني', title: 'المراجع الأكاديمي المعتمد للامتحانات والـ OSPE' }
];
  ...
  return (
    <div className="space-y-6 text-slate-100" id="admin-exams-tab">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-[#0B132B]/80 rounded-xl border border-slate-800 p-4">
          <div className="text-[11px] text-purple-400 font-medium">المراجع الأكاديمي المعتمد</div>
          <div className="text-lg font-black text-purple-300 mt-1">
            الدكتور ثابت الذيفاني
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/60 rounded-xl border border-slate-800 p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
        <div className="flex items-center gap-2 text-slate-300 font-bold">
          ...
          <span>المراجع الأكاديمي المعتمد للامتحانات في جميع الأقسام:</span>
        </div>
        <div className="flex items-center gap-2 flex-wrap">
          <span
            className="px-3 py-1.5 rounded-lg bg-emerald-950/60 text-emerald-300 border border-emerald-500/40 text-xs font-bold flex items-center gap-1.5 shadow-sm"
          >
            <span>الدكتور ثابت الذيفاني</span>
            <span className="text-[10px] text-emerald-400/80 font-normal">(أستاذ ومراجع الامتحانات والـ OSPE)</span>
          </span>
        </div>
      </div>
