...
export const EDUCATIONAL_VIDEOS: EducationalVideo[] = [
  ...
  // ==========================================
  {
    id: 'vid-hist-microscope-001',
    subject: 'histology',
    subjectId: 'histology',
    topicId: 'hist_microscope',
    topicName: 'Optical Microscope & Slide Examination',
    topic: 'Microscope Technique & Focusing',
    title: 'How to Use a Compound Light Microscope in Histology: Focusing & Kohler Illumination',
    titleAr: 'كيفية استخدام المجهر الضوئي وضبط الإضاءة والعدسات لفحص الشرائح',
    instructor: 'Medical Sciences Microscopy Unit',
    instructorTitle: 'Department of Histology & Cell Biology',
    channelTitle: 'Medical Histology Laboratory',
    youtubeVideoId: 'd4qHVe6xmWM',
    youtubeId: 'd4qHVe6xmWM',
    youtubeUrl: 'https://www.youtube.com/watch?v=d4qHVe6xmWM',
    embedUrl: 'https://www.youtube.com/embed/d4qHVe6xmWM',
    ...
    relevanceScore: 100,
    status: 'active',
    source: 'Laboratory Microscopy Training Manual',
    description: 'Systematic guide for medical students to master the compound optical microscope: scanning power (4x), low power (10x), high-dry power (40x), and oil immersion lens (100x) alignment with fine adjustment focus.',
    learningObjectives: [
      'Identify optical and mechanical parts of the compound light microscope',
      'Start scanning at 4x and systematically advance magnification without striking the coverslip',
      'Optimize diaphragm aperture and condenser height for sharp histology specimen contrast'
    ],
    highYieldTakeaways: [
      'Always focus first with coarse adjustment at 4x low power, then exclusively use fine adjustment at 40x and 100x',
      'Condenser position determines image resolution and contrast across stained tissue sections'
    ],
    chapters: [
      { time: '0:00', title: 'Microscope Anatomy & Objective Lenses' },
      { time: '02:10', title: 'Mounting the Slide & Coarse Focusing at 4x' },
      { time: '04:30', title: 'Transitioning to High-Dry Power (40x)' },
      { time: '06:50', title: 'Condenser & Diaphragm Contrast Adjustment' }
    ]
  },
  {
    id: 'vid-hist-prep-001',
    subject: 'histology',
    subjectId: 'histology',
    topicId: 'hist_staining',
    topicName: 'Slide Preparation & H&E Staining',
    topic: 'Tissue Preparation & Staining',
    title: 'Histology Slide Preparation: Fixation, Embedding, Sectioning & H&E Staining',
    titleAr: 'مراحل تحضير الشرائح النسيجية: التثبيت، الطمر، التقطيع بالميكروتوم، والصبغ بـ H&E',
    instructor: 'Histotechnology Educational Series',
    instructorTitle: 'Medical Histopathology Laboratory Services',
    channelTitle: 'Histology Laboratory Protocols',
    youtubeVideoId: 'f-FF7Qigd3U',
    youtubeId: 'f-FF7Qigd3U',
    youtubeUrl: 'https://www.youtube.com/watch?v=f-FF7Qigd3U',
    embedUrl: 'https://www.youtube.com/embed/f-FF7Qigd3U',
    ...
    relevanceScore: 99,
    status: 'active',
    source: 'Medical Histotechnology Standard Protocols',
    description: 'Complete overview of histological specimen preparation: tissue preservation with 10% formalin, paraffin wax embedding, ribbon sectioning on the microtome, water-bath floating, and routine Hematoxylin & Eosin (H&E) staining.',
    learningObjectives: [
      'Understand the chemical purpose of formalin fixation to prevent autolysis',
      'Describe the role of microtome cutting to produce 3–5 micrometer thin sections',
      'Explain the differential binding of Hematoxylin (basic dye for nuclei) and Eosin (acidic dye for cytoplasm)'
    ],
    highYieldTakeaways: [
      'Formalin cross-links proteins and inactivates cellular digestive enzymes',
      'Hematoxylin binds anionic basophilic nucleic acids (blue/purple); Eosin binds cationic acidophilic proteins (pink)'
    ],
    chapters: [
      { time: '0:00', title: 'Tissue Grossing & Formalin Fixation' },
      { time: '02:15', title: 'Dehydration, Clearing & Paraffin Embedding' },
      { time: '04:40', title: 'Microtome Sectioning & Water Bath Floating' },
      { time: '07:10', title: 'H&E Staining Sequence & Coverslipping' }
    ]
  },
  {
    id: 'vid-hist-cartilage-bone-001',
    subject: 'histology',
    subjectId: 'histology',
    topicId: 'hist_specialized_connective',
    topicName: 'Cartilage & Bone Histology',
    topic: 'Cartilage & Compact Bone',
    title: 'Cartilage & Bone Histology: Hyaline, Elastic, Fibrocartilage & Osteons',
    titleAr: 'نسيج الغضروف والعظم مجهرياً: الغضروف الزجاجي والمرن والليفي وقنوات هافرس',
    instructor: 'Department of Anatomy & Histology',
    instructorTitle: 'Faculty Medical Microscopy Education',
    channelTitle: 'Histology Atlas Masterclass',
    youtubeVideoId: 'DLxYDoN634c',
    youtubeId: 'DLxYDoN634c',
    youtubeUrl: 'https://www.youtube.com/watch?v=DLxYDoN634c',
    embedUrl: 'https://www.youtube.com/embed/DLxYDoN634c',
    ...
    relevanceScore: 98,
    status: 'active',
    source: 'Virtual Microscopic Pathology Atlas',
    description: 'Practical microscopic differentiation of Hyaline cartilage (glassy matrix, isogenous chondrocyte clusters), Elastic cartilage (branching elastic fibers), Fibrocartilage (herringbone collagen rows), and Compact Bone with concentric Haversian systems.',
    learningObjectives: [
      'Differentiate the three cartilage types based on matrix composition and fiber content',
      'Identify isogenous nests of chondrocytes nestled within lacunae',
      'Recognize Haversian canals, concentric lamellae, and osteocyte lacunae in compact bone ground sections'
    ],
    highYieldTakeaways: [
      'Hyaline cartilage has a glassy basophilic matrix because Type II collagen fibrils have the same refractive index as ground substance',
      'Elastic cartilage never calcifies with age; Fibrocartilage lacks a true perichondrium',
      'The functional structural unit of compact bone is the Osteon (Haversian system)'
    ],
    chapters: [
      { time: '0:00', title: 'Hyaline Cartilage: Chondrocytes & Perichondrium' },
      { time: '03:20', title: 'Elastic Cartilage: High-Power Elastic Fibers' },
      { time: '06:15', title: 'Fibrocartilage: Parallel Collagen Bundles' },
      { time: '08:45', title: 'Compact Bone: Osteons, Canals & Volkmann Canals' }
    ]
  },
